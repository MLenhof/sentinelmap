...
from modules.integrity_checker import get_integrity_warnings
...
def generate_markdown_report():
    ...
    with open(REPORT_FILE, "w") as file:
        ...
        file.write("## Data Integrity Summary\n\n")

        if not integrity_warnings:
            file.write("No integrity issues detected.\n\n")
        ...
        # Physical Topology Section
        file.write("## Physical Topology Summary\n\n")

        if not switch_ports:
            file.write("No switch port connectivity documented.\n\n")
            ...
            for port in switch_ports:
                ...
                if port["mode"] == "access":
                    ...
                    file.write(
                        f"- Access VLAN: "
                        f"{port['access_vlan']} - {vlan_name}\n"
                    )

                elif port["mode"] == "trunk":

                    native_vlan_name = get_vlan_name(
                        vlans,
                        port["native_vlan"]
                    )
